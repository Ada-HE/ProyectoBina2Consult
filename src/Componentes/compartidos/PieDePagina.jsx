...
const PieDePagina = () => {
  ...
  const fetchSocialMedia = async () => {
    try {
      const response = await axios.get('https://localhost:4000/api/redSocial'); // Tu endpoint de redes sociales
  ...
  const fetchContactInfo = async () => {
    try {
      const response = await axios.get('https://localhost:4000/api/contacto/ver'); // Tu endpoint de contacto
